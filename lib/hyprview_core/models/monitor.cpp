...
std::string Monitor::toString() const {
  ...
  oss << "Monitor[" << id << "] " << name << " (" << width << "x" << height
      << " @ " << refreshRate << "Hz)";
  return oss.str();
}
...
const std::string &Monitor::getDirectScanoutTo() const {
  return directScanoutTo;
}
...
const std::vector<std::string> &Monitor::getAvailableModes() const {
...
void Monitor::setDirectScanoutTo(const std::string &value) {
  directScanoutTo = value;
}
void Monitor::setDisabled(bool value) { disabled = value; }
void Monitor::setCurrentFormat(const std::string &value) {
  currentFormat = value;
}
void Monitor::setMirrorOf(const std::string &value) { mirrorOf = value; }
void Monitor::setAvailableModes(const std::vector<std::string> &value) {
