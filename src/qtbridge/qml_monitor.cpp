...
const core::Monitor *QmlMonitor::getMonitor() const { return m_monitor; }
...
int QmlMonitor::getId() const { return m_monitor->getId(); }
...
int QmlMonitor::getWidth() const { return m_monitor->getWidth(); }
...
int QmlMonitor::getHeight() const { return m_monitor->getHeight(); }
...
int QmlMonitor::getPositionX() const { return m_monitor->getPositionX(); }
...
int QmlMonitor::getPositionY() const { return m_monitor->getPositionY(); }
...
double QmlMonitor::getScale() const { return m_monitor->getScale(); }
...
bool QmlMonitor::getFocused() const { return m_monitor->isFocused(); }
...
bool QmlMonitor::getDpmsStatus() const { return m_monitor->getDpmsStatus(); }
...
bool QmlMonitor::getVrr() const { return m_monitor->isVrrEnabled(); }
...
bool QmlMonitor::isDisabled() const { return m_monitor->isDisabled(); }
