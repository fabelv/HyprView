...
int main(int argc, char *argv[]) {
    ...
    std::unique_ptr<core::HyprMonitorParser> parser = std::make_unique<core::HyprMonitorParser>();
    std::unique_ptr<core::HyprMonitorManager> coreManager = std::make_unique<core::HyprMonitorManager>(parser.get());
    ...
    std::unique_ptr<QmlMonitorManager> qmlManager = std::make_unique<QmlMonitorManager>(coreManager.get());
