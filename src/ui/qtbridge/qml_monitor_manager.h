...
class QmlMonitorManager : public QObject {
  ...
  Q_PROPERTY(
      QList<QmlMonitor *> monitors READ getMonitors NOTIFY monitorsChanged)
  Q_PROPERTY(QmlMonitor *selectedMonitor READ getSelectedMonitor WRITE
                 setSelectedMonitor NOTIFY selectedMonitorChanged)
