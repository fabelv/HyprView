...
class QmlMonitor : public QObject {
  ...
  Q_PROPERTY(double refreshRate_ READ getRefreshRate WRITE setRefreshRate NOTIFY
                 updated)
  ...
  Q_PROPERTY(
      bool dpmsStatus_ READ getDpmsStatus WRITE setDpmsStatus NOTIFY updated)
  Q_PROPERTY(bool vrr_ READ getVrr WRITE setVrr NOTIFY updated)
  Q_PROPERTY(
      QString solitary_ READ getSolitary WRITE setSolitary NOTIFY updated)
  Q_PROPERTY(bool activelyTearing_ READ getActivelyTearing WRITE
                 setActivelyTearing NOTIFY updated)
  Q_PROPERTY(QString directScanoutTo_ READ getDirectScanoutTo WRITE
                 setDirectScanoutTo NOTIFY updated)
  Q_PROPERTY(bool disabled_ READ getDisabled WRITE setDisabled NOTIFY updated)
  Q_PROPERTY(QString currentFormat_ READ getCurrentFormat WRITE setCurrentFormat
                 NOTIFY updated)
  Q_PROPERTY(
      QString mirrorOf_ READ getMirrorOf WRITE setMirrorOf NOTIFY updated)
  Q_PROPERTY(QStringList availableModes_ READ getAvailableModes WRITE
                 setAvailableModes NOTIFY updated)
