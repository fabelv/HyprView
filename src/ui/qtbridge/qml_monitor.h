...
class QmlMonitor : public QObject {
  ...
  Q_PROPERTY(double refreshRate READ getRefreshRate WRITE setRefreshRate NOTIFY
                 updated)
  ...
  Q_PROPERTY(
      bool dpmsStatus READ getDpmsStatus WRITE setDpmsStatus NOTIFY updated)
  ...
  Q_PROPERTY(bool activelyTearing READ getActivelyTearing WRITE
                 setActivelyTearing NOTIFY updated)
  Q_PROPERTY(QString directScanoutTo READ getDirectScanoutTo WRITE
                 setDirectScanoutTo NOTIFY updated)
  Q_PROPERTY(bool disabled READ isDisabled WRITE setDisabled NOTIFY updated)
  Q_PROPERTY(QString currentFormat READ getCurrentFormat WRITE setCurrentFormat
                 NOTIFY updated)
  Q_PROPERTY(QString mirrorOf READ getMirrorOf WRITE setMirrorOf NOTIFY updated)
  Q_PROPERTY(QStringList availableModes READ getAvailableModes WRITE
