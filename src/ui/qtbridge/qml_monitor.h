...
namespace qtbridge {
    ...
    class QmlMonitor : public QObject {
        ...
        Q_PROPERTY(bool activelyTearing_ READ getActivelyTearing WRITE setActivelyTearing NOTIFY updated)
        Q_PROPERTY(QString directScanoutTo_ READ getDirectScanoutTo WRITE setDirectScanoutTo NOTIFY updated)
        ...
        Q_PROPERTY(QStringList availableModes_ READ getAvailableModes WRITE setAvailableModes NOTIFY updated)
